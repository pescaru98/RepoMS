<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="OnlinePharmacy.Pages.Register" %>
    ...
    <form id="form1" runat="server" style="text-align: center;" class="w-100 container row justify-content-center mt-5">
        <div class="form-logreg bg-white rounded-25" style="border: 1px solid #007bff; width: 25em;">
            <div class="mb-5" style="background: #007bff; border-radius: 25px;">
                <strong>
                    <br />
                    <div style="color: white; font-size: 40px;">Register </div>
                    <br />
                </strong>
            </div>
            ...
            <br />
            <a href="/Pages/Login.aspx">Back to login</a>
            <br />
            <br />
            <asp:Button ID="btnLogin" runat="server" CssClass="btn btn-primary col-8" OnClick="Button1_Click" Text="Create" Width="214px" />
            <br />
            <br />
            <br />
        </div>
